...
elseif(BLAS STREQUAL "eigen")
  message("Using Blas = Eigen")
  include_directories(SYSTEM /opt/eigen/include/eigen3/Eigen/src/misc/)
  list(APPEND mshadow_LINKER_LIBS /opt/eigen/lib/libeigen_blas.so)
  list(APPEND mshadow_LINKER_LIBS /opt/eigen/lib/libeigen_lapack.so)
  add_definitions(-DMSHADOW_USE_CBLAS=0)
  add_definitions(-DMSHADOW_USE_MKL=0)
  add_definitions(-DMXNET_USE_EIGEN=1)
