...
int MXSymbolInferShapeExInt64(SymbolHandle sym,
  ...
  MXAPIThreadLocalEntry::SetupShapeArrayReturnWithBufferExInt64(ret->arg_shapes,
      &(ret->arg_shape_ndim_ex), &(ret->arg_shape_data_ex_int64), &(ret->arg_shape_buffer_ex_int64));
  MXAPIThreadLocalEntry::SetupShapeArrayReturnWithBufferExInt64(ret->out_shapes,
      &(ret->out_shape_ndim_ex), &(ret->out_shape_data_ex_int64), &(ret->out_shape_buffer_ex_int64));
  MXAPIThreadLocalEntry::SetupShapeArrayReturnWithBufferExInt64(ret->aux_shapes,
      &(ret->aux_shape_ndim_ex), &(ret->aux_shape_data_ex_int64), &(ret->aux_shape_buffer_ex_int64));
  *in_shape_size = static_cast<mx_uint>(ret->arg_shapes.size());
  *in_shape_ndim = dmlc::BeginPtr(ret->arg_shape_ndim_ex);
...
int MXSymbolInferShapePartialExInt64(SymbolHandle sym,
  ...
  int succ;
  *complete = 1;
  return MXSymbolInferShapeExInt64(sym, num_args, keys,
                              arg_ind_ptr, arg_shape_data,
                              in_shape_size, in_shape_ndim, in_shape_data,
                              out_shape_size, out_shape_ndim, out_shape_data,
                              aux_shape_size, aux_shape_ndim, aux_shape_data,
